<?php
   ...
   @session_start() ;
   $_SESSION['scriptcase']['app_logged_users']['glo_nm_perfil']          = "conn_mysql";
   ...
   $_SESSION['scriptcase']['app_logged_users']['glo_nm_path_cache']      = "";
   $_SESSION['scriptcase']['app_logged_users']['glo_nm_path_doc']        = "";
    ...
    //check cache
    if(empty($_SESSION['scriptcase']['app_logged_users']['glo_nm_path_cache']))
    {
            /*check tmp*/$_SESSION['scriptcase']['app_logged_users']['glo_nm_path_cache'] = $str_path_apl_dir . "_lib/file/cache";
    }
    //check doc
...
// 
      ...
      $this->path_cache  = $_SESSION['scriptcase']['app_logged_users']['glo_nm_path_cache'];
      ...
      if (!isset($_SESSION['scriptcase']['app_logged_users']['save_session']['save_grid_state_session']))
      { 
          $_SESSION['scriptcase']['app_logged_users']['save_session']['save_grid_state_session'] = false;
          $_SESSION['scriptcase']['app_logged_users']['save_session']['data'] = '';
      } 
      ...
      $this->str_schema_filter = (isset($_SESSION['scriptcase']['str_schema_all']) && !empty($_SESSION['scriptcase']['str_schema_all'])) ? $_SESSION['scriptcase']['str_schema_all'] : "rhino/rhino";
...
<?php
      ...
      if (!isset($_SESSION['sc_session'][$this->sc_page]['app_logged_users']['dashboard_info']['under_dashboard']))
      {
          ...
          $_SESSION['sc_session'][$this->sc_page]['app_logged_users']['dashboard_info']['remove_border']   = false;
      }
      if (isset($_GET['under_dashboard']) && 1 == $_GET['under_dashboard'])
      {
          if (isset($_GET['own_widget']) && 'dbifrm_widget' == substr($_GET['own_widget'], 0, 13)) {
              ...
              if (isset($_GET['remove_border'])) {
                  $_SESSION['sc_session'][$this->sc_page]['app_logged_users']['dashboard_info']['remove_border'] = 1 == $_GET['remove_border'];
              }
          }
      }
      elseif (isset($under_dashboard) && 1 == $under_dashboard)
      {
          if (isset($own_widget) && 'dbifrm_widget' == substr($own_widget, 0, 13)) {
              ...
              if (isset($remove_border)) {
                  $_SESSION['sc_session'][$this->sc_page]['app_logged_users']['dashboard_info']['remove_border'] = 1 == $remove_border;
              }
          }
      }
      ...
      if ($_SESSION['sc_session'][$this->sc_page]['app_logged_users']['dashboard_info']['under_dashboard'])
      {
        ...
        if (isset($link_compact_mode) && 'ok' == $link_compact_mode) {
            if (!isset($_SESSION['sc_session'][$this->sc_page]['app_logged_users']['link_info'])) {
                $_SESSION['sc_session'][$this->sc_page]['app_logged_users']['link_info'] = array();
            }
            $_SESSION['sc_session'][$this->sc_page]['app_logged_users']['link_info']['compact_mode'] = true;
        }
        if (isset($link_remove_margin) && 'ok' == $link_remove_margin) {
            if (!isset($_SESSION['sc_session'][$this->sc_page]['app_logged_users']['link_info'])) {
                $_SESSION['sc_session'][$this->sc_page]['app_logged_users']['link_info'] = array();
            }
            $_SESSION['sc_session'][$this->sc_page]['app_logged_users']['link_info']['remove_margin'] = true;
        }
        if (isset($link_remove_border) && 'ok' == $link_remove_border) {
            if (!isset($_SESSION['sc_session'][$this->sc_page]['app_logged_users']['link_info'])) {
                $_SESSION['sc_session'][$this->sc_page]['app_logged_users']['link_info'] = array();
            }
            $_SESSION['sc_session'][$this->sc_page]['app_logged_users']['link_info']['remove_border'] = true;
        }
...
<?php
   ...
   function conectDB()
   {
      ...
      { 
          $this->Db = db_conect_devel($_SESSION['scriptcase']['app_logged_users']['glo_nm_conexao'], $this->root . $this->path_prod, 'Monitoreo_Clientes', 1, $this->force_db_utf8); 
      } 
      else 
      { 
          ob_start();
...
//----- 
   function controle($linhas = 0)
   {
      ...
      if (!$_SESSION['sc_session'][$this->Ini->sc_page]['app_logged_users']['embutida'])
      {
          ...
          if (isset($_POST['nmgp_opcao']) && ($_POST['nmgp_opcao'] == "ajax_navigate" || $_POST['nmgp_opcao'] == "ajax_detalhe"))
          {
              ...
              if (($_POST['opc'] == "igual" || $_POST['opc'] == "resumo") && isset($_POST['parm']) && ($_POST['parm'] == "reload" || $_POST['parm'] == "breload"))
              {
                  ...
                  $_SESSION['sc_session'][$script_case_init]['app_logged_users']['contr_array_resumo'] = "NAO";
                  unset($_SESSION['sc_session'][$script_case_init]['app_logged_users']['tot_geral']);
                  unset($_SESSION['sc_session'][$script_case_init]['app_logged_users']['arr_total']);
                  unset($_SESSION['sc_session'][$script_case_init]['app_logged_users']['pivot_group_by']);
                  unset($_SESSION['sc_session'][$script_case_init]['app_logged_users']['pivot_x_axys']);
                  unset($_SESSION['sc_session'][$script_case_init]['app_logged_users']['pivot_y_axys']);
                  unset($_SESSION['sc_session'][$script_case_init]['app_logged_users']['pivot_fill']);
                  unset($_SESSION['sc_session'][$script_case_init]['app_logged_users']['pivot_order']);
                  unset($_SESSION['sc_session'][$script_case_init]['app_logged_users']['pivot_order_col']);
                  unset($_SESSION['sc_session'][$script_case_init]['app_logged_users']['pivot_order_level']);
                  unset($_SESSION['sc_session'][$script_case_init]['app_logged_users']['pivot_order_sort']);
                  unset($_SESSION['sc_session'][$script_case_init]['app_logged_users']['pivot_tabular']);
              }
      ...
      $_SESSION['sc_session'][$this->Ini->sc_page]['app_logged_users']['json_return'] = ($nmgp_opcao == "json") ? "volta_grid" : "resumo"; 
      ...
      { 
          $nmgp_opcao = "json"; 
          $_SESSION['sc_session'][$this->Ini->sc_page]['app_logged_users']['opcao'] = "json"; 
      }
      elseif ($nmgp_opcao == "json" && strpos(" " . $this->Ini->SC_module_export, "grid") === false)  
      { 
          $nmgp_opcao = "json_res"; 
          $_SESSION['sc_session'][$this->Ini->sc_page]['app_logged_users']['opcao'] = "json_res"; 
      }
      ...
      $_SESSION['sc_session'][$this->Ini->sc_page]['app_logged_users']['conf_chart_level'] = "S";
...
//
      ...
      { 
         ...
         $_SESSION['sc_session'][$this->Ini->sc_page]['app_logged_users']['where_pesq_grid']   = "";
         $_SESSION['sc_session'][$this->Ini->sc_page]['app_logged_users']['where_pesq_lookup'] = "";
         $_SESSION['sc_session'][$this->Ini->sc_page]['app_logged_users']['campos_busca']      = array();
         $_SESSION['sc_session'][$this->Ini->sc_page]['app_logged_users']['grid_pesq']         = array();
         $_SESSION['sc_session'][$this->Ini->sc_page]['app_logged_users']['Grid_search']       = array();
      ...
      if (!$_SESSION['sc_session'][$this->Ini->sc_page]['app_logged_users']['embutida'])
      {
         if ($nm_flag_pdf && $nm_vendo_pdf)
         {
            ...
            $nm_arquivo_pdf_base = "/sc_pdf_" . md5(date("Ymd") . "_" . session_id()) . "_app_logged_users.pdf";
...
//----------------------------------->
      ...
      { 
          ...
          {
              $Pos = strrpos($_SESSION['sc_session'][$this->Ini->sc_page]['app_logged_users']['word_name'], ".");
              if ($Pos === false) {
                  $_SESSION['sc_session'][$this->Ini->sc_page]['app_logged_users']['word_name'] .= ".doc";
              }
      ...
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['app_logged_users']['opcao'] == "json")  
      { 
          if ($_SESSION['sc_session'][$this->Ini->sc_page]['app_logged_users']['embutida'])
          { 
              require_once($this->Ini->path_embutida . "app_logged_users/app_logged_users_json.class.php"); 
          } 
          else 
          { 
              require_once($this->Ini->path_aplicacao . "app_logged_users_json.class.php"); 
          } 
          $this->json  = new app_logged_users_json();
         ...
         if ($nm_flag_pdf && $nm_vendo_pdf)
         {
            ...
            if (!$this->Ini->sc_export_ajax && !$_SESSION['sc_session'][$this->Ini->sc_page]['app_logged_users']['pdf_det'])
            {
                if (-1 < $this->grid->progress_grid && $this->grid->progress_fp)
                {
                    ...
                    app_logged_users_pdf_progress_call($this->grid->progress_tot . "_#NM#_" . $this->grid->progress_tot . "_#NM#_" . $lang_protect . "...\n", $this->Ini->Nm_lang);
            ...
            {
                $Pos = strrpos($_SESSION['sc_session'][$this->Ini->sc_page]['app_logged_users']['pdf_name'], ".");
                if ($Pos === false) {
                    $_SESSION['sc_session'][$this->Ini->sc_page]['app_logged_users']['pdf_name'] .= ".pdf";
                }
                if ('/' == substr($_SESSION['sc_session'][$this->Ini->sc_page]['app_logged_users']['pdf_name'], 0, 1)) {
                    $_SESSION['sc_session'][$this->Ini->sc_page]['app_logged_users']['pdf_name'] = substr($_SESSION['sc_session'][$this->Ini->sc_page]['app_logged_users']['pdf_name'], 1);
                }
            ...
            if (!$_SESSION['sc_session'][$this->Ini->sc_page]['app_logged_users']['pdf_det'])
            {
                if (-1 < $this->grid->progress_grid && $this->grid->progress_fp)
                {
                    ...
                    if ($this->grid->progress_fp)
                    {
                        ...
                        app_logged_users_pdf_progress_call($this->grid->progress_tot . "_#NM#_" . ($this->grid->progress_now + 1 + $this->grid->progress_pdf) . "_#NM#_" . $lang_protect . "...\n", $this->Ini->Nm_lang);
                        app_logged_users_pdf_progress_call("off\n", $this->Ini->Nm_lang);
...
$NM_volta  = "volta_grid";
$NM_target = "_parent";
$downloadFileName = "app_logged_users.pdf";
if ($this->pdf_zip == 'S') {
...
<?php
    $_SESSION['sc_session'][$this->Ini->sc_page]['app_logged_users'][md5("newpdf_" . $downloadFileName)][0] = $nm_arquivo_pdf_url;
    $_SESSION['sc_session'][$this->Ini->sc_page]['app_logged_users'][md5("newpdf_" . $downloadFileName)][1] = $downloadFileName;
}
...
<?php
  ...
  function close_emb()
  {
   ...
   function SC_fast_search($in_fields, $arg_search, $data_search)
   {
      ...
      $_SESSION['sc_session'][$this->Ini->sc_page]['app_logged_users']['fast_search'][0] = $in_fields;
...
//======= =========================
   ...
   if ($Sem_Session && (!isset($nmgp_start) || $nmgp_start != "SC")) {
       ...
       elseif (is_file($root . $_SESSION['scriptcase']['app_logged_users']['glo_nm_path_imag_temp'] . "/sc_apl_default_Monitoreo_Clientes.txt")) {
           $apl_def = explode(",", file_get_contents($root . $_SESSION['scriptcase']['app_logged_users']['glo_nm_path_imag_temp'] . "/sc_apl_default_Monitoreo_Clientes.txt"));
       }
       if (isset($apl_def)) {
           ...
           if (isset($_COOKIE['sc_actual_lang_Monitoreo_Clientes'])) {
               $_SESSION['scriptcase']['app_logged_users']['session_timeout']['lang'] = $_COOKIE['sc_actual_lang_Monitoreo_Clientes'];
           }
       }
   }
...
// 
       ...
       if (isset($nmgp_parms_ret)) 
       {
           ...
           $_SESSION['sc_session'][$script_case_init]['app_logged_users']['psq_edit'] = 'N';   
           if (isset($nmgp_perm_edit)) {
               $_SESSION['sc_session'][$script_case_init]['app_logged_users']['psq_edit'] = $nmgp_perm_edit;
           }
       } 
...
//
   ...
   function app_logged_users_pack_protect_string($sString)
   {
    ...
    function app_logged_users_pdf_progress_call($message, $Nm_lang, $flushBuffer = false) {
