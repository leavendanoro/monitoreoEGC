...
if (!isset($_SESSION['sc_session']))
{
    ...
    if (is_file($root . $_SESSION['scriptcase']['app_logged_users']['glo_nm_path_imag_temp'] . "/sc_apl_default_Monitoreo_Clientes.txt"))
    {
?>
<html>
 <body>
...
<?php
if (isset($_SESSION['sc_session'][$aParams['script_case_init']]['app_logged_users']['pdf_name'])) {
    $Pos = strrpos($_SESSION['sc_session'][$aParams['script_case_init']]['app_logged_users']['pdf_name'], ".");
    if ($Pos === false) {
        $_SESSION['sc_session'][$aParams['script_case_init']]['app_logged_users']['pdf_name'] .= ".pdf";
    }
}
$NM_pdfbase = (isset($_SESSION['sc_session'][$aParams['script_case_init']]['app_logged_users']['pdf_name'])) ? $_SESSION['sc_session'][$aParams['script_case_init']]['app_logged_users']['pdf_name'] : 'sc_pdf_' . md5(date('Ymd') . '_' . session_id()) . '_app_logged_users.pdf';
...
$_SESSION['sc_session'][$aParams['script_case_init']]['app_logged_users'][$path_doc_md5][0] = $_SESSION['scriptcase']['app_logged_users']['glo_nm_path_imag_temp'] . "/" . $NM_tit_doc;
