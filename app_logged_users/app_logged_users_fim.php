...
//----- 
   ...
   if (isset($_SESSION['session_sec_aplicacao']["Monitoreo_Clientes_____app_logged_users"]))
   {
      unset($_SESSION['session_sec_aplicacao']["Monitoreo_Clientes_____app_logged_users"]);
   }
