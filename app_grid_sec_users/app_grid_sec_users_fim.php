...
//----- 
   ...
   if (isset($_SESSION['session_sec_aplicacao']["Monitoreo_Clientes_____app_grid_sec_users"]))
   {
      unset($_SESSION['session_sec_aplicacao']["Monitoreo_Clientes_____app_grid_sec_users"]);
   }
