...
//----- 
   ...
   if (isset($_SESSION['session_sec_aplicacao']["Monitoreo_Clientes_____app_change_pswd"]))
   {
      unset($_SESSION['session_sec_aplicacao']["Monitoreo_Clientes_____app_change_pswd"]);
   }
