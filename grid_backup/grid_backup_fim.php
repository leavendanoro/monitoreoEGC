...
//----- 
   ...
   if (isset($_SESSION['session_sec_aplicacao']["Monitoreo_Clientes_____grid_backup"]))
   {
      unset($_SESSION['session_sec_aplicacao']["Monitoreo_Clientes_____grid_backup"]);
   }
   ...
   $_SESSION['sc_session'][$script_case_init]['form_backup'] = array();
   $fecha_janela = false;
   ...
   if ((isset($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['grid_backup']['opc_psq']) && $_SESSION['sc_session'][$script_case_init]['grid_backup']['opc_psq']) || $fecha_janela)
   {
       if (isset($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['grid_backup']['sc_modal']) && $_SESSION['sc_session'][$script_case_init]['grid_backup']['sc_modal'])
       {
           unset($_SESSION['sc_session'][$script_case_init]['grid_backup']['sc_modal']);
...
<?php
   ...
   function nm_limpa_arr_session()
   {
      ...
      if (isset($_SESSION['sc_session'][$script_case_init]['grid_backup']['embutida_filho']))
      {
          foreach ($_SESSION['sc_session'][$script_case_init]['grid_backup']['embutida_filho'] as $ind => $sc_init)
          {
