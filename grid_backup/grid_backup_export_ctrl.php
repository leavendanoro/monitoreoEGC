<?php
@session_start() ;
$_SESSION['scriptcase']['grid_backup']['sc_process_barr'] = true;
require_once('../grid_backup/index.php');
unset($_SESSION['scriptcase']['grid_backup']['sc_process_barr']);
$ExportCtrl = new grid_backup_export_control;
$ExportCtrl->Export_barr();

class grid_backup_export_control
{
