  ...
  function scAjaxUpdateErrors(sType)
  {
    ...
    if (oResp["errList"])
    {
      for (iFieldErrors = 0; iFieldErrors < oResp["errList"].length; iFieldErrors++)
      {
        ...
        if ("geral_form_respuestas" == sTestField)
        {
...
?>
  ...
  // ---------- Validate respuesta_
  function do_ajax_form_respuestas_validate_respuesta_(iNumLinha)
  {
    var nomeCampo_respuesta_ = "respuesta_" + iNumLinha;
    var var_respuesta_ = scAjaxGetFieldText(nomeCampo_respuesta_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_respuestas_validate_respuesta_(var_respuesta_, iNumLinha, var_script_case_init, do_ajax_form_respuestas_validate_respuesta__cb);
  } // do_ajax_form_respuestas_validate_respuesta_

  function do_ajax_form_respuestas_validate_respuesta__cb(sResp)
  {
    ...
    if ("" != iLineNumber)
    {
      sFieldValid = "respuesta_" + iLineNumber;
    }
    else
    {
      sFieldValid = "respuesta_";
    }
    ...
    if ("" == sFieldErrors)
    {
      ...
      scErrorLineOff(iLineNumber, "respuesta_");
    }
    else
    {
      var sImgStatus = sc_img_status_err;
      scAjaxShowErrorDisplay(sFieldValid, sFieldErrors);
      scErrorLineOn(iLineNumber, "respuesta_");
    }
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_respuestas_validate_respuesta__cb

  var sc_num_ult_line = "";
  var sc_insert_open  = false;

  // ---------- add_new_line
  function do_ajax_form_respuestas_add_new_line(sc_clone, sc_seq_clone)
  {
    if (sc_insert_open)
    {
        if (sc_clone == 'S' && sc_seq_clone != iAjaxNewLine)
        {
          do_ajax_form_respuestas_cancel_insert(iAjaxNewLine);
        }
        else
        {
          return;
    ...
    var var_script_case_init = document.F1.script_case_init.value;
    scAjaxProcOn(true);
    x_ajax_form_respuestas_add_new_line(var_sc_clone, var_sc_seq_clone, var_sc_seq_vert, var_script_case_init, do_ajax_form_respuestas_add_new_line_cb);
  } // do_ajax_form_respuestas_add_new_line

  function do_ajax_form_respuestas_add_new_line_cb(sResp)
  {
    scAjaxProcOff(true);
    if ("{" == sResp.substr(0, 1)) {
        oResp = scAjaxResponse(sResp);
  ...
  } // do_ajax_form_respuestas_add_new_line_cb

  // ---------- backup_line
  function do_ajax_form_respuestas_backup_line(iNumLinha)
  {
    var var_respuesta_ = scAjaxGetFieldText("respuesta_" + iNumLinha);
    var var_nmgp_refresh_row = iNumLinha;
    var var_nm_form_submit = document.F1.nm_form_submit.value;
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_respuestas_backup_line(var_respuesta_, var_nmgp_refresh_row, var_nm_form_submit, var_script_case_init, do_ajax_form_respuestas_backup_line_cb);
  } // do_ajax_form_respuestas_backup_line

  function do_ajax_form_respuestas_backup_line_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    if (!scAjaxHasError())
  ...
  } // do_ajax_form_respuestas_backup_line_cb

  function do_ajax_form_respuestas_cancel_insert(iSeqVert)
  {
    var oTBodyOld = document.getElementById("hidden_bloco_0").tBodies[0];
  ...
  } // do_ajax_form_respuestas_cancel_insert

  function do_ajax_form_respuestas_cancel_update(iSeqVert)
  {
    do_ajax_form_respuestas_backup_line(iSeqVert);
...
?>
  } // do_ajax_form_respuestas_cancel_update

  function do_ajax_form_respuestas_restore_buttons()
  {
<?php
...
?>
  } // do_ajax_form_respuestas_restore_buttons

  // ---------- table_refresh
  function do_ajax_form_respuestas_table_refresh()
  {
    var var_respuesta_ = document.F2.respuesta_.value;
    ...
    scAjaxProcOn();
    x_ajax_form_respuestas_table_refresh(var_respuesta_, var_nm_form_submit, var_nmgp_opcao, var_nmgp_ordem, var_nmgp_fast_search, var_nmgp_cond_fast_search, var_nmgp_arg_fast_search, var_nmgp_arg_dyn_search, var_script_case_init, do_ajax_form_respuestas_table_refresh_cb);
  } //  do_ajax_form_respuestas_table_refresh

  function do_ajax_form_respuestas_table_refresh_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    document.F2.respuesta_.value = scAjaxGetKeyValue("respuesta_");
    ...
    scAjaxAlert(do_ajax_form_respuestas_table_refresh_cb_after_alert);
  } // do_ajax_form_respuestas_table_refresh_cb
  function do_ajax_form_respuestas_table_refresh_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    ...
    sc_insert_open = false;
  } // do_ajax_form_respuestas_table_refresh_cb_after_alert
...
function scJs_sweetalert_params(params) {
  ...
  var sc_num_ult_opc  = "";
  var sc_num_ult_tr   = "";
  function do_ajax_form_respuestas_submit_form(iNumLinha, indexTR)
  {
    if (scEventControl_active(iNumLinha)) {
      setTimeout(function() { do_ajax_form_respuestas_submit_form(iNumLinha, indexTR); }, 500);
      return;
    }
...
?>
    x_ajax_form_respuestas_submit_form(var_respuesta_, var_nmgp_refresh_row, var_nm_form_submit, var_nmgp_url_saida, var_nmgp_opcao, var_nmgp_ancora, var_nmgp_num_form, var_nmgp_parms, var_script_case_init, var_csrf_token, do_ajax_form_respuestas_submit_form_cb);
  } // do_ajax_form_respuestas_submit_form

  function do_ajax_form_respuestas_submit_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
...
?>
      ...
      scAjaxHideErrorDisplay("table");
      scAjaxHideErrorDisplay("respuesta_" + sc_num_ult_line);
<?php
if (isset($this->Embutida_form) && $this->Embutida_form) {
?>
      scAjaxSetReadonly();
...
?>
    ...
    scAjaxSetLabel(true);
    scAjaxSetMaster();
    scAjaxAlert(do_ajax_form_respuestas_submit_form_cb_after_alert);
  } // do_ajax_form_respuestas_submit_form_cb
  function do_ajax_form_respuestas_submit_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  ...
  } // do_ajax_form_respuestas_submit_form_cb_after_alert

  var scStatusDetail = {};

  function do_ajax_form_respuestas_navigate_form()
  {
    perform_ajax_form_respuestas_navigate_form();
  }

  function perform_ajax_form_respuestas_navigate_form()
  {
    if (scRefreshTable())
    {
      return;
    ...
    if (sc_insert_open)
    {
        do_ajax_form_respuestas_cancel_insert(sc_form_respuestas_get_last_line_number());
    }
    nm_uncheck_delete();
    scAjaxHideMessage();
    scAjaxHideErrorDisplay("table");
    ...
    {
      scAjaxHideErrorDisplay("respuesta_" + iNavForm);
    }
    var var_respuesta_ = document.F2.respuesta_.value;
    var var_nm_form_submit = document.F2.nm_form_submit.value;
    var var_nmgp_opcao = document.F2.nmgp_opcao.value;
    ...
    var var_script_case_init = document.F2.script_case_init.value;
    scAjaxProcOn();
    x_ajax_form_respuestas_navigate_form(var_respuesta_, var_nm_form_submit, var_nmgp_opcao, var_nmgp_ordem, var_nmgp_arg_dyn_search, var_script_case_init, do_ajax_form_respuestas_navigate_form_cb);
  } // do_ajax_form_respuestas_navigate_form

  var scMasterDetailParentIframe = "<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['form_respuestas']['dashboard_info']['parent_widget'] ?>";
...
?>
  function do_ajax_form_respuestas_navigate_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetFields(false);
    scAjaxSetVariables();
    document.F2.respuesta_.value = scAjaxGetKeyValue("respuesta_" + var_last_index);
    ...
    scErrorLineReset();
    $('.sc-js-ui-statusimg').css('display', 'none');
    scAjaxAlert(do_ajax_form_respuestas_navigate_form_cb_after_alert);
  } // do_ajax_form_respuestas_navigate_form_cb
  function do_ajax_form_respuestas_navigate_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
<?php
...
?>
  ...
  } // do_ajax_form_respuestas_navigate_form_cb_after_alert

    function sc_form_respuestas_get_last_line_number()
    {
    ...
    } //sc_form_respuestas_get_last_line_number

  function sc_hide_form_respuestas_form()
  {
...
?>
  ...
  {
    ajax_field_list[iTotCampos] = "respuesta_" + iNumLinha;
    iTotCampos++;
    ajax_error_list["respuesta_" + iNumLinha] = {"label": "Respuesta<?php echo $sLineInfo; ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5};
    ajax_field_mult["respuesta_"][iNumLinha] = "respuesta_" + iNumLinha;
    ajax_field_id["respuesta_" + iNumLinha] = new Array("hidden_field_label_respuesta_", "hidden_field_data_respuesta_" + iNumLinha);
    ajax_error_count["respuesta_" + iNumLinha] = "off";
<?php
if (!$this->Grid_editavel)
{
?>
    ajax_read_only["respuesta_" + iNumLinha] = "on";
<?php
}
else
{
...
?>
  ...
  {
    ajax_error_list["respuesta_" + iNumLinha] = null;
  }
  ...
  function scRemoveErrors()
  {
    for (iNumLinha = 1; iNumLinha < Lim_linhas; iNumLinha++)
    {
      ajax_error_list["respuesta_" + iNumLinha]["valid"] = new Array();
      ajax_error_list["respuesta_" + iNumLinha]["onblur"] = new Array();
      ajax_error_list["respuesta_" + iNumLinha]["onchange"] = new Array();
      ajax_error_list["respuesta_" + iNumLinha]["onclick"] = new Array();
      ajax_error_list["respuesta_" + iNumLinha]["onfocus"] = new Array();
    }
  }
...
?>
  ...
  {
<?php
  $NM_contr_readonly = (isset($this->nmgp_cmp_readonly['respuesta_'])) ? $this->nmgp_cmp_readonly['respuesta_'] : 'on';
?>
    scAjaxFieldRead("respuesta_" + iSeq, "<?php echo $NM_contr_readonly ?>");
  }

  function mdCloseObjects(iSeq)
  {
    scAjaxFieldRead("respuesta_" + iSeq, "on");
    rerunHeaderDisplay = 1;
    scSetFixedHeaders(true);
  }
...
?>
  ...
  function scErrorLineOff(iRow, sIdError)
  {
    ...
    if (bErrorRow || ("off" == ajax_error_count["respuesta_" + iRow]))
    {
      if (bErrorRow)
      {
        ajax_error_count["respuesta_" + iRow] = "off";
      }
      ...
      $("#hidden_field_data_respuesta_" + iRow).removeClass("scFormErrorLine");
    }
  }
