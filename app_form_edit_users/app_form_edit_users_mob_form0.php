...
<span id="id_read_on_login" class="sc-ui-readonly-login css_login_line" style="<?php echo $sStyleReadLab_login; ?>"><?php echo $this->form_format_readonly("login", $this->form_encode_input($this->login)); ?></span><span id="id_read_off_login" class="css_read_off_login<?php echo $this->classes_100perc_fields['span_input'] ?>" style="white-space: nowrap;<?php echo $sStyleReadInp_login; ?>">
 ...
 <?php if ($this->classes_100perc_fields['keep_field_size']) { echo "size=23"; } ?> maxlength=32 alt="{datatype: 'text', maxLength: 32, allowedChars: '<?php echo $this->allowedCharsCharset("") ?>', lettersCase: '', enterTab: false, enterSubmit: false, autoTab: false, selectOnFocus: true, watermark: '', watermarkClass: 'scFormObjectOddWm', maskChars: '(){}[].,;:-+/ '}" ></span><?php } ?>
 </TD>
   <?php }?>
...
<script type="text/javascript">
	function scBtnFn_sys_format_ini() {
		...
		if ($("#sc_b_ini_t.sc-unique-btn-14").length && $("#sc_b_ini_t.sc-unique-btn-14").is(":visible")) {
		    if ($("#sc_b_ini_t.sc-unique-btn-14").hasClass("disabled")) {
		        return;
		    }
			nm_move ('inicio');
			 return;
	...
	function scBtnFn_sys_format_ret() {
		...
		if ($("#sc_b_ret_t.sc-unique-btn-15").length && $("#sc_b_ret_t.sc-unique-btn-15").is(":visible")) {
		    if ($("#sc_b_ret_t.sc-unique-btn-15").hasClass("disabled")) {
		        return;
		    }
			nm_move ('retorna');
			 return;
	...
	function scBtnFn_sys_format_ava() {
		...
		if ($("#sc_b_avc_t.sc-unique-btn-16").length && $("#sc_b_avc_t.sc-unique-btn-16").is(":visible")) {
		    if ($("#sc_b_avc_t.sc-unique-btn-16").hasClass("disabled")) {
		        return;
		    }
			nm_move ('avanca');
			 return;
	...
	function scBtnFn_sys_format_fim() {
		...
		if ($("#sc_b_fim_t.sc-unique-btn-17").length && $("#sc_b_fim_t.sc-unique-btn-17").is(":visible")) {
		    if ($("#sc_b_fim_t.sc-unique-btn-17").hasClass("disabled")) {
		        return;
		    }
			nm_move ('final');
			 return;
	...
	function scBtnFn_sys_format_inc() {
		...
		if ($("#sc_b_new_b.sc-unique-btn-18").length && $("#sc_b_new_b.sc-unique-btn-18").is(":visible")) {
		    if ($("#sc_b_new_b.sc-unique-btn-18").hasClass("disabled")) {
		        return;
		    }
			nm_move ('novo');
			 return;
		...
		if ($("#sc_b_ins_b.sc-unique-btn-19").length && $("#sc_b_ins_b.sc-unique-btn-19").is(":visible")) {
		    if ($("#sc_b_ins_b.sc-unique-btn-19").hasClass("disabled")) {
		        return;
		    }
			nm_atualiza ('incluir');
			 return;
	...
	function scBtnFn_sys_format_exc() {
		if ($("#sc_b_del_b.sc-unique-btn-8").length && $("#sc_b_del_b.sc-unique-btn-8").is(":visible")) {
		    if ($("#sc_b_del_b.sc-unique-btn-8").hasClass("disabled")) {
		        return;
		    }
			nm_atualiza ('excluir');
			 return;
		...
		if ($("#sc_b_del_b.sc-unique-btn-21").length && $("#sc_b_del_b.sc-unique-btn-21").is(":visible")) {
		    if ($("#sc_b_del_b.sc-unique-btn-21").hasClass("disabled")) {
		        return;
		    }
			nm_atualiza ('excluir');
			 return;
