...
<?php
  exit;
    ...
    function getButtonIds($buttonName) {
        switch ($buttonName) {
            case "first":
                return array("sc_b_ini_t.sc-unique-btn-1", "sc_b_ini_t.sc-unique-btn-14");
                break;
            case "back":
                return array("sc_b_ret_t.sc-unique-btn-2", "sc_b_ret_t.sc-unique-btn-15");
                break;
            case "forward":
                return array("sc_b_avc_t.sc-unique-btn-3", "sc_b_avc_t.sc-unique-btn-16");
                break;
            case "last":
                return array("sc_b_fim_t.sc-unique-btn-4", "sc_b_fim_t.sc-unique-btn-17");
                break;
            case "new":
                return array("sc_b_new_b.sc-unique-btn-5", "sc_b_new_b.sc-unique-btn-18");
                break;
            case "insert":
                return array("sc_b_ins_b.sc-unique-btn-6", "sc_b_ins_b.sc-unique-btn-19");
                break;
            case "update":
                return array("sc_b_upd_b.sc-unique-btn-7", "sc_b_upd_b.sc-unique-btn-20");
                break;
            case "delete":
                return array("sc_b_del_b.sc-unique-btn-8", "sc_b_del_b.sc-unique-btn-21");
                break;
            case "help":
                return array("sc_b_hlp_b");
                break;
            case "exit":
                return array("sc_b_sai_b.sc-unique-btn-9", "sc_b_sai_b.sc-unique-btn-10", "sc_b_sai_b.sc-unique-btn-12", "sc_b_sai_b.sc-unique-btn-22", "sc_b_sai_b.sc-unique-btn-23", "sc_b_sai_b.sc-unique-btn-25", "sc_b_sai_b.sc-unique-btn-11", "sc_b_sai_b.sc-unique-btn-13", "sc_b_sai_b.sc-unique-btn-24", "sc_b_sai_b.sc-unique-btn-26");
                break;
        }
