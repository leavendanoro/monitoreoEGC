  ...
  function scAjaxUpdateErrors(sType)
  {
    ...
    if (oResp["errList"])
    {
      for (iFieldErrors = 0; iFieldErrors < oResp["errList"].length; iFieldErrors++)
      {
        ...
        if ("geral_form_monitor_dpi_pdf_mob" == sTestField)
        {
...
//    return document.F1.elements[sFieldName].value.replace(/[+]/g, "__NM_PLUS__");
  ...
  function scMoveMasterDetail(widget)
  {
	...
	function scAjax_displayEmptyForm() {
        ...
        sc_hide_form_monitor_dpi_pdf_mob_form();
	}
...
?>
  ...
  // ---------- Validate fecha
  function do_ajax_form_monitor_dpi_pdf_mob_validate_fecha()
  {
    ...
    setTimeout(function() {
      var var_fecha = scAjaxGetFieldText(nomeCampo_fecha);
      x_ajax_form_monitor_dpi_pdf_mob_validate_fecha(var_fecha, var_script_case_init, do_ajax_form_monitor_dpi_pdf_mob_validate_fecha_cb);
    }, 200);
  } // do_ajax_form_monitor_dpi_pdf_mob_validate_fecha

  function do_ajax_form_monitor_dpi_pdf_mob_validate_fecha_cb(sResp)
  {
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_monitor_dpi_pdf_mob_validate_fecha_cb

  // ---------- Validate id_cliente
  function do_ajax_form_monitor_dpi_pdf_mob_validate_id_cliente()
  {
    var nomeCampo_id_cliente = "id_cliente";
    var var_id_cliente = scAjaxGetFieldText(nomeCampo_id_cliente);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_monitor_dpi_pdf_mob_validate_id_cliente(var_id_cliente, var_script_case_init, do_ajax_form_monitor_dpi_pdf_mob_validate_id_cliente_cb);
  } // do_ajax_form_monitor_dpi_pdf_mob_validate_id_cliente

  function do_ajax_form_monitor_dpi_pdf_mob_validate_id_cliente_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_monitor_dpi_pdf_mob_validate_id_cliente_cb

  // ---------- Validate equipo
  function do_ajax_form_monitor_dpi_pdf_mob_validate_equipo()
  {
    var nomeCampo_equipo = "equipo";
    var var_equipo = scAjaxGetFieldText(nomeCampo_equipo);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_monitor_dpi_pdf_mob_validate_equipo(var_equipo, var_script_case_init, do_ajax_form_monitor_dpi_pdf_mob_validate_equipo_cb);
  } // do_ajax_form_monitor_dpi_pdf_mob_validate_equipo

  function do_ajax_form_monitor_dpi_pdf_mob_validate_equipo_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "equipo";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_monitor_dpi_pdf_mob_validate_equipo_cb

  // ---------- Validate modules
  function do_ajax_form_monitor_dpi_pdf_mob_validate_modules()
  {
    var nomeCampo_modules = "modules";
    var var_modules = scAjaxGetFieldText(nomeCampo_modules);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_monitor_dpi_pdf_mob_validate_modules(var_modules, var_script_case_init, do_ajax_form_monitor_dpi_pdf_mob_validate_modules_cb);
  } // do_ajax_form_monitor_dpi_pdf_mob_validate_modules

  function do_ajax_form_monitor_dpi_pdf_mob_validate_modules_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "modules";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_monitor_dpi_pdf_mob_validate_modules_cb

  // ---------- Validate drdl
  function do_ajax_form_monitor_dpi_pdf_mob_validate_drdl()
  {
    var nomeCampo_drdl = "drdl";
    var var_drdl = scAjaxGetFieldText(nomeCampo_drdl);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_monitor_dpi_pdf_mob_validate_drdl(var_drdl, var_script_case_init, do_ajax_form_monitor_dpi_pdf_mob_validate_drdl_cb);
  } // do_ajax_form_monitor_dpi_pdf_mob_validate_drdl

  function do_ajax_form_monitor_dpi_pdf_mob_validate_drdl_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "drdl";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_monitor_dpi_pdf_mob_validate_drdl_cb

  // ---------- Validate interface
  function do_ajax_form_monitor_dpi_pdf_mob_validate_interface()
  {
    var nomeCampo_interface = "interface";
    var var_interface = scAjaxGetFieldText(nomeCampo_interface);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_monitor_dpi_pdf_mob_validate_interface(var_interface, var_script_case_init, do_ajax_form_monitor_dpi_pdf_mob_validate_interface_cb);
  } // do_ajax_form_monitor_dpi_pdf_mob_validate_interface

  function do_ajax_form_monitor_dpi_pdf_mob_validate_interface_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "interface";
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sFieldErrors = scAjaxListFieldErrors(sFieldValid, false);
    if ("" == sFieldErrors)
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_monitor_dpi_pdf_mob_validate_interface_cb

  // ---------- Validate cpu
  function do_ajax_form_monitor_dpi_pdf_mob_validate_cpu()
  {
    var nomeCampo_cpu = "cpu";
    var var_cpu = scAjaxGetFieldText(nomeCampo_cpu);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_monitor_dpi_pdf_mob_validate_cpu(var_cpu, var_script_case_init, do_ajax_form_monitor_dpi_pdf_mob_validate_cpu_cb);
  } // do_ajax_form_monitor_dpi_pdf_mob_validate_cpu

  function do_ajax_form_monitor_dpi_pdf_mob_validate_cpu_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "cpu";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_monitor_dpi_pdf_mob_validate_cpu_cb

  // ---------- Validate memory
  function do_ajax_form_monitor_dpi_pdf_mob_validate_memory()
  {
    var nomeCampo_memory = "memory";
    var var_memory = scAjaxGetFieldText(nomeCampo_memory);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_monitor_dpi_pdf_mob_validate_memory(var_memory, var_script_case_init, do_ajax_form_monitor_dpi_pdf_mob_validate_memory_cb);
  } // do_ajax_form_monitor_dpi_pdf_mob_validate_memory

  function do_ajax_form_monitor_dpi_pdf_mob_validate_memory_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "memory";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_monitor_dpi_pdf_mob_validate_memory_cb

  // ---------- Validate bw
  function do_ajax_form_monitor_dpi_pdf_mob_validate_bw()
  {
    var nomeCampo_bw = "bw";
    var var_bw = scAjaxGetFieldText(nomeCampo_bw);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_monitor_dpi_pdf_mob_validate_bw(var_bw, var_script_case_init, do_ajax_form_monitor_dpi_pdf_mob_validate_bw_cb);
  } // do_ajax_form_monitor_dpi_pdf_mob_validate_bw

  function do_ajax_form_monitor_dpi_pdf_mob_validate_bw_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "bw";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_monitor_dpi_pdf_mob_validate_bw_cb

  // ---------- Validate disk
  function do_ajax_form_monitor_dpi_pdf_mob_validate_disk()
  {
    var nomeCampo_disk = "disk";
    var var_disk = scAjaxGetFieldText(nomeCampo_disk);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_monitor_dpi_pdf_mob_validate_disk(var_disk, var_script_case_init, do_ajax_form_monitor_dpi_pdf_mob_validate_disk_cb);
  } // do_ajax_form_monitor_dpi_pdf_mob_validate_disk

  function do_ajax_form_monitor_dpi_pdf_mob_validate_disk_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "disk";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_monitor_dpi_pdf_mob_validate_disk_cb

  // ---------- Validate storage
  function do_ajax_form_monitor_dpi_pdf_mob_validate_storage()
  {
    var nomeCampo_storage = "storage";
    var var_storage = scAjaxGetFieldText(nomeCampo_storage);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_monitor_dpi_pdf_mob_validate_storage(var_storage, var_script_case_init, do_ajax_form_monitor_dpi_pdf_mob_validate_storage_cb);
  } // do_ajax_form_monitor_dpi_pdf_mob_validate_storage

  function do_ajax_form_monitor_dpi_pdf_mob_validate_storage_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "storage";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_monitor_dpi_pdf_mob_validate_storage_cb

  // ---------- Validate backup
  function do_ajax_form_monitor_dpi_pdf_mob_validate_backup()
  {
    var nomeCampo_backup = "backup";
    var var_backup = scAjaxGetFieldText(nomeCampo_backup);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_monitor_dpi_pdf_mob_validate_backup(var_backup, var_script_case_init, do_ajax_form_monitor_dpi_pdf_mob_validate_backup_cb);
  } // do_ajax_form_monitor_dpi_pdf_mob_validate_backup

  function do_ajax_form_monitor_dpi_pdf_mob_validate_backup_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "backup";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_monitor_dpi_pdf_mob_validate_backup_cb

  // ---------- Validate alertas
  function do_ajax_form_monitor_dpi_pdf_mob_validate_alertas()
  {
    var nomeCampo_alertas = "alertas";
    var var_alertas = scAjaxGetFieldText(nomeCampo_alertas);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_monitor_dpi_pdf_mob_validate_alertas(var_alertas, var_script_case_init, do_ajax_form_monitor_dpi_pdf_mob_validate_alertas_cb);
  } // do_ajax_form_monitor_dpi_pdf_mob_validate_alertas

  function do_ajax_form_monitor_dpi_pdf_mob_validate_alertas_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "alertas";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_monitor_dpi_pdf_mob_validate_alertas_cb

  // ---------- Validate observaciones
  function do_ajax_form_monitor_dpi_pdf_mob_validate_observaciones()
  {
    var nomeCampo_observaciones = "observaciones";
    var var_observaciones = scAjaxGetFieldText(nomeCampo_observaciones);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_monitor_dpi_pdf_mob_validate_observaciones(var_observaciones, var_script_case_init, do_ajax_form_monitor_dpi_pdf_mob_validate_observaciones_cb);
  } // do_ajax_form_monitor_dpi_pdf_mob_validate_observaciones

  function do_ajax_form_monitor_dpi_pdf_mob_validate_observaciones_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_monitor_dpi_pdf_mob_validate_observaciones_cb

  // ---------- Validate user_mon
  function do_ajax_form_monitor_dpi_pdf_mob_validate_user_mon()
  {
    var nomeCampo_user_mon = "user_mon";
    var var_user_mon = scAjaxGetFieldText(nomeCampo_user_mon);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_monitor_dpi_pdf_mob_validate_user_mon(var_user_mon, var_script_case_init, do_ajax_form_monitor_dpi_pdf_mob_validate_user_mon_cb);
  } // do_ajax_form_monitor_dpi_pdf_mob_validate_user_mon

  function do_ajax_form_monitor_dpi_pdf_mob_validate_user_mon_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "user_mon";
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sFieldErrors = scAjaxListFieldErrors(sFieldValid, false);
    if ("" == sFieldErrors)
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_monitor_dpi_pdf_mob_validate_user_mon_cb
...
function scJs_sweetalert_params(params) {
  ...
  // ---------- Form
  function do_ajax_form_monitor_dpi_pdf_mob_submit_form()
  {
    if (scEventControl_active("")) {
      setTimeout(function() { do_ajax_form_monitor_dpi_pdf_mob_submit_form(); }, 500);
      return;
    }
    scAjaxHideMessage();
    var var_fecha = scAjaxGetFieldText("fecha");
    var var_id_cliente = scAjaxGetFieldText("id_cliente");
    var var_equipo = scAjaxGetFieldText("equipo");
    var var_modules = scAjaxGetFieldText("modules");
    var var_drdl = scAjaxGetFieldText("drdl");
    var var_interface = scAjaxGetFieldText("interface");
    var var_cpu = scAjaxGetFieldText("cpu");
    var var_memory = scAjaxGetFieldText("memory");
    var var_bw = scAjaxGetFieldText("bw");
    var var_disk = scAjaxGetFieldText("disk");
    var var_storage = scAjaxGetFieldText("storage");
    var var_backup = scAjaxGetFieldText("backup");
    var var_alertas = scAjaxGetFieldText("alertas");
    var var_observaciones = scAjaxGetFieldText("observaciones");
    var var_user_mon = scAjaxGetFieldText("user_mon");
    ...
    scAjaxProcOn();
    x_ajax_form_monitor_dpi_pdf_mob_submit_form(var_fecha, var_id_cliente, var_equipo, var_modules, var_drdl, var_interface, var_cpu, var_memory, var_bw, var_disk, var_storage, var_backup, var_alertas, var_observaciones, var_user_mon, var_nm_form_submit, var_nmgp_url_saida, var_nmgp_opcao, var_nmgp_ancora, var_nmgp_num_form, var_nmgp_parms, var_script_case_init, var_csrf_token, do_ajax_form_monitor_dpi_pdf_mob_submit_form_cb);
  } // do_ajax_form_monitor_dpi_pdf_mob_submit_form

  function do_ajax_form_monitor_dpi_pdf_mob_submit_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    ...
    if (scAjaxIsOk())
    {
      ...
      scAjaxHideErrorDisplay("equipo");
      scAjaxHideErrorDisplay("modules");
      scAjaxHideErrorDisplay("drdl");
      scAjaxHideErrorDisplay("interface");
      scAjaxHideErrorDisplay("cpu");
      scAjaxHideErrorDisplay("memory");
      scAjaxHideErrorDisplay("bw");
      scAjaxHideErrorDisplay("disk");
      scAjaxHideErrorDisplay("storage");
      scAjaxHideErrorDisplay("backup");
      scAjaxHideErrorDisplay("alertas");
      scAjaxHideErrorDisplay("observaciones");
      scAjaxHideErrorDisplay("user_mon");
      scLigEditLookupCall();
<?php
...
?>
    ...
    scAjaxSetLabel();
    scAjaxSetReadonly();
    scAjaxAlert(do_ajax_form_monitor_dpi_pdf_mob_submit_form_cb_after_alert);
  } // do_ajax_form_monitor_dpi_pdf_mob_submit_form_cb
  function do_ajax_form_monitor_dpi_pdf_mob_submit_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  ...
  } // do_ajax_form_monitor_dpi_pdf_mob_submit_form_cb_after_alert

  var scStatusDetail = {};

  function do_ajax_form_monitor_dpi_pdf_mob_navigate_form()
  {
    perform_ajax_form_monitor_dpi_pdf_mob_navigate_form();
  }

  function perform_ajax_form_monitor_dpi_pdf_mob_navigate_form()
  {
    if (scRefreshTable())
    {
      return;
    ...
    scAjaxHideErrorDisplay("observaciones");
    scAjaxHideErrorDisplay("user_mon");
    var var_fecha = document.F2.fecha.value;
    var var_id_cliente = document.F2.id_cliente.value;
    var var_equipo = document.F2.equipo.value;
    ...
    scAjaxProcOn();
    x_ajax_form_monitor_dpi_pdf_mob_navigate_form(var_fecha, var_id_cliente, var_equipo, var_nm_form_submit, var_nmgp_opcao, var_nmgp_ordem, var_nmgp_fast_search,  var_nmgp_cond_fast_search,  var_nmgp_arg_fast_search, var_nmgp_arg_dyn_search, var_script_case_init, do_ajax_form_monitor_dpi_pdf_mob_navigate_form_cb);
  } // do_ajax_form_monitor_dpi_pdf_mob_navigate_form

  var scMasterDetailParentIframe = "<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['form_monitor_dpi_pdf_mob']['dashboard_info']['parent_widget'] ?>";
...
?>
  function do_ajax_form_monitor_dpi_pdf_mob_navigate_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetFields(false);
    scAjaxSetVariables();
    document.F2.fecha.value = scAjaxGetKeyValue("fecha");
    document.F2.id_cliente.value = scAjaxGetKeyValue("id_cliente");
    document.F2.equipo.value = scAjaxGetKeyValue("equipo");
    scAjaxSetSummary();
    scAjaxSetNavpage();
    scAjaxShowDebug();
    scAjaxSetLabel(true);
    ...
    scAjaxSetBtnVars();
    $('.sc-js-ui-statusimg').css('display', 'none');
    scAjaxAlert(do_ajax_form_monitor_dpi_pdf_mob_navigate_form_cb_after_alert);
  } // do_ajax_form_monitor_dpi_pdf_mob_navigate_form_cb
  function do_ajax_form_monitor_dpi_pdf_mob_navigate_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
...
{
?>
    do_ajax_form_monitor_dpi_pdf_mob_restore_buttons();
<?php
}
?>
    if (hasJsFormOnload)
  ...
  } // do_ajax_form_monitor_dpi_pdf_mob_navigate_form_cb_after_alert

  function sc_hide_form_monitor_dpi_pdf_mob_form()
  {
  ...
  ajax_field_list[2] = "equipo";
  ajax_field_list[3] = "modules";
  ajax_field_list[4] = "drdl";
  ajax_field_list[5] = "interface";
  ajax_field_list[6] = "cpu";
  ajax_field_list[7] = "memory";
  ajax_field_list[8] = "bw";
  ajax_field_list[9] = "disk";
  ajax_field_list[10] = "storage";
  ajax_field_list[11] = "backup";
  ajax_field_list[12] = "alertas";
  ajax_field_list[13] = "observaciones";
  ajax_field_list[14] = "user_mon";
  ...
  var ajax_error_list = {
    ...
    "equipo": {"label": "Equipo", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
    "modules": {"label": "Modules", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
    "drdl": {"label": "Drdl", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
    "interface": {"label": "Interface", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
    "cpu": {"label": "Cpu", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
    "memory": {"label": "Memory", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
    "bw": {"label": "Bw", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
    "disk": {"label": "Disk", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
    "storage": {"label": "Storage", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
    "backup": {"label": "Backup", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
    "alertas": {"label": "Alertas", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
    ...
    "user_mon": {"label": "User Mon", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5}
  };
  ...
  ajax_field_mult["equipo"][1] = "equipo";
  ajax_field_mult["modules"][1] = "modules";
  ajax_field_mult["drdl"][1] = "drdl";
  ajax_field_mult["interface"][1] = "interface";
  ajax_field_mult["cpu"][1] = "cpu";
  ajax_field_mult["memory"][1] = "memory";
  ajax_field_mult["bw"][1] = "bw";
  ajax_field_mult["disk"][1] = "disk";
  ajax_field_mult["storage"][1] = "storage";
  ajax_field_mult["backup"][1] = "backup";
  ajax_field_mult["alertas"][1] = "alertas";
  ajax_field_mult["observaciones"][1] = "observaciones";
  ajax_field_mult["user_mon"][1] = "user_mon";
  ...
  var ajax_field_id = {
    ...
    "equipo": new Array("hidden_field_label_equipo", "hidden_field_data_equipo"),
    "modules": new Array("hidden_field_label_modules", "hidden_field_data_modules"),
    "drdl": new Array("hidden_field_label_drdl", "hidden_field_data_drdl"),
    "interface": new Array("hidden_field_label_interface", "hidden_field_data_interface"),
    "cpu": new Array("hidden_field_label_cpu", "hidden_field_data_cpu"),
    "memory": new Array("hidden_field_label_memory", "hidden_field_data_memory"),
    "bw": new Array("hidden_field_label_bw", "hidden_field_data_bw"),
    "disk": new Array("hidden_field_label_disk", "hidden_field_data_disk"),
    "storage": new Array("hidden_field_label_storage", "hidden_field_data_storage"),
    "backup": new Array("hidden_field_label_backup", "hidden_field_data_backup"),
    "alertas": new Array("hidden_field_label_alertas", "hidden_field_data_alertas"),
    "observaciones": new Array("hidden_field_label_observaciones", "hidden_field_data_observaciones"),
    "user_mon": new Array("hidden_field_label_user_mon", "hidden_field_data_user_mon")
  };
