...
$old_error_handler = set_error_handler("form_monitor_dpi_pdf_scriptcase_error_handler");

function form_monitor_dpi_pdf_scriptcase_error_handler($err_no, $err_msg, $err_file, $err_line, $exibe)
{
    ...
    if (isset($_SESSION['scriptcase']['form_monitor_dpi_pdf']['contr_erro']) && $_SESSION['scriptcase']['form_monitor_dpi_pdf']['contr_erro'] == 'on')
    {
    ...
    if (in_array($err_no, $errors_handled))
    {
        ...
        if ($bol_flag && $exibe)
        {
            ...
            $inicial_form_monitor_dpi_pdf->contr_form_monitor_dpi_pdf->Apl_com_erro = true;
            if ($inicial_form_monitor_dpi_pdf->contr_form_monitor_dpi_pdf->NM_ajax_flag)
            {
                $inicial_form_monitor_dpi_pdf->contr_form_monitor_dpi_pdf->NM_ajax_info['errList']['geral_form_monitor_dpi_pdf'][] = $msg;
                return;
            }
            form_monitor_dpi_pdf_scriptcase_error_display($msg, $err_no);
        }
        return;
    }
}

function form_monitor_dpi_pdf_scriptcase_error_display($err_msg, $err_no)
{
    ...
    if (!$erro_ja_exibido)
    {
        ...
        $sErrorIcon      = (isset($_SESSION['scriptcase']['error_icon']['form_monitor_dpi_pdf'])  && '' != $_SESSION['scriptcase']['error_icon']['form_monitor_dpi_pdf'])  ? $_SESSION['scriptcase']['error_icon']['form_monitor_dpi_pdf']  : "";
        ...
        $bSpanTitle      = (isset($_SESSION['scriptcase']['error_span_title']['form_monitor_dpi_pdf']) && '' != $_SESSION['scriptcase']['error_span_title']['form_monitor_dpi_pdf']) ? $_SESSION['scriptcase']['error_span_title']['form_monitor_dpi_pdf'] : false;
        $sIconTitle      = (isset($_SESSION['scriptcase']['error_icon_title']['form_monitor_dpi_pdf']) && '' != $_SESSION['scriptcase']['error_icon_title']['form_monitor_dpi_pdf']) ? $_SESSION['scriptcase']['error_icon_title']['form_monitor_dpi_pdf'] : '';
?>
