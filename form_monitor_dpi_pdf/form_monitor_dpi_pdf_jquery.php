...
function scJQEventsAdd(iSeqRow) {
  $('#id_sc_field_fecha' + iSeqRow).bind('blur', function() { sc_form_monitor_dpi_pdf_fecha_onblur(this, iSeqRow) })
                                   .bind('change', function() { sc_form_monitor_dpi_pdf_fecha_onchange(this, iSeqRow) })
  ...
  $('#id_sc_field_id_cliente' + iSeqRow).bind('blur', function() { sc_form_monitor_dpi_pdf_id_cliente_onblur(this, iSeqRow) })
                                        .bind('change', function() { sc_form_monitor_dpi_pdf_id_cliente_onchange(this, iSeqRow) })
  ...
  $('#id_sc_field_equipo' + iSeqRow).bind('blur', function() { sc_form_monitor_dpi_pdf_equipo_onblur(this, iSeqRow) })
                                    .bind('change', function() { sc_form_monitor_dpi_pdf_equipo_onchange(this, iSeqRow) })
  ...
  $('#id_sc_field_modules' + iSeqRow).bind('blur', function() { sc_form_monitor_dpi_pdf_modules_onblur(this, iSeqRow) })
                                     .bind('change', function() { sc_form_monitor_dpi_pdf_modules_onchange(this, iSeqRow) })
  ...
  $('#id_sc_field_drdl' + iSeqRow).bind('blur', function() { sc_form_monitor_dpi_pdf_drdl_onblur(this, iSeqRow) })
                                  .bind('change', function() { sc_form_monitor_dpi_pdf_drdl_onchange(this, iSeqRow) })
  ...
  $('#id_sc_field_interface' + iSeqRow).bind('blur', function() { sc_form_monitor_dpi_pdf_interface_onblur(this, iSeqRow) })
                                       .bind('change', function() { sc_form_monitor_dpi_pdf_interface_onchange(this, iSeqRow) })
  ...
  $('#id_sc_field_cpu' + iSeqRow).bind('blur', function() { sc_form_monitor_dpi_pdf_cpu_onblur(this, iSeqRow) })
                                 .bind('change', function() { sc_form_monitor_dpi_pdf_cpu_onchange(this, iSeqRow) })
  ...
  $('#id_sc_field_memory' + iSeqRow).bind('blur', function() { sc_form_monitor_dpi_pdf_memory_onblur(this, iSeqRow) })
                                    .bind('change', function() { sc_form_monitor_dpi_pdf_memory_onchange(this, iSeqRow) })
  ...
  $('#id_sc_field_bw' + iSeqRow).bind('blur', function() { sc_form_monitor_dpi_pdf_bw_onblur(this, iSeqRow) })
                                .bind('change', function() { sc_form_monitor_dpi_pdf_bw_onchange(this, iSeqRow) })
  ...
  $('#id_sc_field_disk' + iSeqRow).bind('blur', function() { sc_form_monitor_dpi_pdf_disk_onblur(this, iSeqRow) })
                                  .bind('change', function() { sc_form_monitor_dpi_pdf_disk_onchange(this, iSeqRow) })
  ...
  $('#id_sc_field_storage' + iSeqRow).bind('blur', function() { sc_form_monitor_dpi_pdf_storage_onblur(this, iSeqRow) })
                                     .bind('change', function() { sc_form_monitor_dpi_pdf_storage_onchange(this, iSeqRow) })
  ...
  $('#id_sc_field_backup' + iSeqRow).bind('blur', function() { sc_form_monitor_dpi_pdf_backup_onblur(this, iSeqRow) })
                                    .bind('change', function() { sc_form_monitor_dpi_pdf_backup_onchange(this, iSeqRow) })
  ...
  $('#id_sc_field_alertas' + iSeqRow).bind('blur', function() { sc_form_monitor_dpi_pdf_alertas_onblur(this, iSeqRow) })
                                     .bind('change', function() { sc_form_monitor_dpi_pdf_alertas_onchange(this, iSeqRow) })
  ...
  $('#id_sc_field_observaciones' + iSeqRow).bind('blur', function() { sc_form_monitor_dpi_pdf_observaciones_onblur(this, iSeqRow) })
                                           .bind('change', function() { sc_form_monitor_dpi_pdf_observaciones_onchange(this, iSeqRow) })
  ...
  $('#id_sc_field_user_mon' + iSeqRow).bind('blur', function() { sc_form_monitor_dpi_pdf_user_mon_onblur(this, iSeqRow) })
                                      .bind('change', function() { sc_form_monitor_dpi_pdf_user_mon_onchange(this, iSeqRow) })
...
function sc_form_monitor_dpi_pdf_fecha_onchange(oThis, iSeqRow) {
  scMarkFormAsChanged();
}
...
function sc_form_monitor_dpi_pdf_id_cliente_onchange(oThis, iSeqRow) {
  scMarkFormAsChanged();
}
...
function sc_form_monitor_dpi_pdf_equipo_onchange(oThis, iSeqRow) {
  scMarkFormAsChanged();
}
...
function sc_form_monitor_dpi_pdf_modules_onchange(oThis, iSeqRow) {
  scMarkFormAsChanged();
}
...
function sc_form_monitor_dpi_pdf_drdl_onchange(oThis, iSeqRow) {
  scMarkFormAsChanged();
}
...
function sc_form_monitor_dpi_pdf_interface_onchange(oThis, iSeqRow) {
  scMarkFormAsChanged();
}
...
function sc_form_monitor_dpi_pdf_cpu_onchange(oThis, iSeqRow) {
  scMarkFormAsChanged();
}
...
function sc_form_monitor_dpi_pdf_memory_onchange(oThis, iSeqRow) {
  scMarkFormAsChanged();
}
...
function sc_form_monitor_dpi_pdf_bw_onchange(oThis, iSeqRow) {
  scMarkFormAsChanged();
}
...
function sc_form_monitor_dpi_pdf_disk_onchange(oThis, iSeqRow) {
  scMarkFormAsChanged();
}
...
function sc_form_monitor_dpi_pdf_storage_onchange(oThis, iSeqRow) {
  scMarkFormAsChanged();
}
...
function sc_form_monitor_dpi_pdf_backup_onchange(oThis, iSeqRow) {
  scMarkFormAsChanged();
}
...
function sc_form_monitor_dpi_pdf_alertas_onchange(oThis, iSeqRow) {
  scMarkFormAsChanged();
}
...
function sc_form_monitor_dpi_pdf_observaciones_onchange(oThis, iSeqRow) {
  scMarkFormAsChanged();
}
...
function sc_form_monitor_dpi_pdf_user_mon_onchange(oThis, iSeqRow) {
  scMarkFormAsChanged();
}
...
function scHidePage(pageNo) {
	$("#id_form_monitor_dpi_pdf_form" + pageNo).hide();
}
...
function scJQCalendarAdd(iSeqRow) {
  $("#id_sc_field_fecha" + iSeqRow).datepicker({
    ...
    onClose: function(dateText, inst) {
      setTimeout(function() { do_ajax_form_monitor_dpi_pdf_validate_fecha(iSeqRow); }, 200);
    },
    showWeek: true,
    numberOfMonths: 1,
    changeMonth: true,
            ...
            if(!$(t).is('img')){
                ...
                switch(field){
                     ...
                     if(usa_read_only && $('a',$('#id_read_on_'+field+iSeqRow)).length == 0){
                         $(t).html("<a href=\"javascript:nm_mostra_doc('0', '"+rs2+"', 'form_monitor_dpi_pdf')\">"+$('#id_read_on_'+field+iSeqRow).text()+"</a>");
                     }
                }
