  ...
  function scAjaxUpdateErrors(sType)
  {
    ...
    if (oResp["errList"])
    {
      for (iFieldErrors = 0; iFieldErrors < oResp["errList"].length; iFieldErrors++)
      {
        ...
        if ("geral_form_cliente_sophos_editar" == sTestField)
        {
...
//    return document.F1.elements[sFieldName].value.replace(/[+]/g, "__NM_PLUS__");
  ...
  function scMoveMasterDetail(widget)
  {
	...
	function scAjax_displayEmptyForm() {
        ...
        sc_hide_form_cliente_sophos_editar_form();
	}
...
?>
  ...
  // ---------- Validate id_cliente_
  function do_ajax_form_cliente_sophos_editar_validate_id_cliente_(iNumLinha)
  {
    var nomeCampo_id_cliente_ = "id_cliente_" + iNumLinha;
    var var_id_cliente_ = scAjaxGetFieldText(nomeCampo_id_cliente_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_cliente_sophos_editar_validate_id_cliente_(var_id_cliente_, iNumLinha, var_script_case_init, do_ajax_form_cliente_sophos_editar_validate_id_cliente__cb);
  } // do_ajax_form_cliente_sophos_editar_validate_id_cliente_

  function do_ajax_form_cliente_sophos_editar_validate_id_cliente__cb(sResp)
  {
    ...
    if ("" != iLineNumber)
    {
      sFieldValid = "id_cliente_" + iLineNumber;
    }
    else
    {
      sFieldValid = "id_cliente_";
    }
    ...
    if ("" == sFieldErrors)
    {
      ...
      scErrorLineOff(iLineNumber, "id_cliente_");
    }
    else
    {
      var sImgStatus = sc_img_status_err;
      scAjaxShowErrorDisplay(sFieldValid, sFieldErrors);
      scErrorLineOn(iLineNumber, "id_cliente_");
    }
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_cliente_sophos_editar_validate_id_cliente__cb

  // ---------- Validate nombre_
  function do_ajax_form_cliente_sophos_editar_validate_nombre_(iNumLinha)
  {
    var nomeCampo_nombre_ = "nombre_" + iNumLinha;
    var var_nombre_ = scAjaxGetFieldText(nomeCampo_nombre_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_cliente_sophos_editar_validate_nombre_(var_nombre_, iNumLinha, var_script_case_init, do_ajax_form_cliente_sophos_editar_validate_nombre__cb);
  } // do_ajax_form_cliente_sophos_editar_validate_nombre_

  function do_ajax_form_cliente_sophos_editar_validate_nombre__cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    iLineNumber = scAjaxGetLineNumber();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_cliente_sophos_editar_validate_nombre__cb

  // ---------- Validate fecha_sla_inicio_
  function do_ajax_form_cliente_sophos_editar_validate_fecha_sla_inicio_(iNumLinha)
  {
    var nomeCampo_fecha_sla_inicio_ = "fecha_sla_inicio_" + iNumLinha;
    var var_fecha_sla_inicio_ = scAjaxGetFieldText(nomeCampo_fecha_sla_inicio_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_cliente_sophos_editar_validate_fecha_sla_inicio_(var_fecha_sla_inicio_, iNumLinha, var_script_case_init, do_ajax_form_cliente_sophos_editar_validate_fecha_sla_inicio__cb);
  } // do_ajax_form_cliente_sophos_editar_validate_fecha_sla_inicio_

  function do_ajax_form_cliente_sophos_editar_validate_fecha_sla_inicio__cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    iLineNumber = scAjaxGetLineNumber();
    if ("" != iLineNumber)
    {
      sFieldValid = "fecha_sla_inicio_" + iLineNumber;
    }
    else
    {
      sFieldValid = "fecha_sla_inicio_";
    }
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sFieldErrors = scAjaxListFieldErrors(sFieldValid, false);
    if ("" == sFieldErrors)
    {
      var sImgStatus = sc_img_status_ok;
      scAjaxHideErrorDisplay(sFieldValid);
      scErrorLineOff(iLineNumber, "fecha_sla_inicio_");
    }
    else
    {
      var sImgStatus = sc_img_status_err;
      scAjaxShowErrorDisplay(sFieldValid, sFieldErrors);
      scErrorLineOn(iLineNumber, "fecha_sla_inicio_");
    }
    var $oImg = $('#id_sc_status_' + sFieldValid);
    if (0 < $oImg.length)
    {
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_cliente_sophos_editar_validate_fecha_sla_inicio__cb

  // ---------- Validate fecha_sla_fin_
  function do_ajax_form_cliente_sophos_editar_validate_fecha_sla_fin_(iNumLinha)
  {
    var nomeCampo_fecha_sla_fin_ = "fecha_sla_fin_" + iNumLinha;
    var var_fecha_sla_fin_ = scAjaxGetFieldText(nomeCampo_fecha_sla_fin_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_cliente_sophos_editar_validate_fecha_sla_fin_(var_fecha_sla_fin_, iNumLinha, var_script_case_init, do_ajax_form_cliente_sophos_editar_validate_fecha_sla_fin__cb);
  } // do_ajax_form_cliente_sophos_editar_validate_fecha_sla_fin_

  function do_ajax_form_cliente_sophos_editar_validate_fecha_sla_fin__cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    iLineNumber = scAjaxGetLineNumber();
    if ("" != iLineNumber)
    {
      sFieldValid = "fecha_sla_fin_" + iLineNumber;
    }
    else
    {
      sFieldValid = "fecha_sla_fin_";
    }
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sFieldErrors = scAjaxListFieldErrors(sFieldValid, false);
    if ("" == sFieldErrors)
    {
      var sImgStatus = sc_img_status_ok;
      scAjaxHideErrorDisplay(sFieldValid);
      scErrorLineOff(iLineNumber, "fecha_sla_fin_");
    }
    else
    {
      var sImgStatus = sc_img_status_err;
      scAjaxShowErrorDisplay(sFieldValid, sFieldErrors);
      scErrorLineOn(iLineNumber, "fecha_sla_fin_");
    }
    var $oImg = $('#id_sc_status_' + sFieldValid);
    if (0 < $oImg.length)
    {
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_cliente_sophos_editar_validate_fecha_sla_fin__cb

  var sc_num_ult_line = "";
  var sc_insert_open  = false;

  // ---------- add_new_line
  function do_ajax_form_cliente_sophos_editar_add_new_line(sc_clone, sc_seq_clone)
  {
    if (sc_insert_open)
    {
        if (sc_clone == 'S' && sc_seq_clone != iAjaxNewLine)
        {
          do_ajax_form_cliente_sophos_editar_cancel_insert(iAjaxNewLine);
        }
        else
        {
          return;
    ...
    var var_script_case_init = document.F1.script_case_init.value;
    scAjaxProcOn(true);
    x_ajax_form_cliente_sophos_editar_add_new_line(var_sc_clone, var_sc_seq_clone, var_sc_seq_vert, var_script_case_init, do_ajax_form_cliente_sophos_editar_add_new_line_cb);
  } // do_ajax_form_cliente_sophos_editar_add_new_line

  function do_ajax_form_cliente_sophos_editar_add_new_line_cb(sResp)
  {
    scAjaxProcOff(true);
    if ("{" == sResp.substr(0, 1)) {
        oResp = scAjaxResponse(sResp);
  ...
  } // do_ajax_form_cliente_sophos_editar_add_new_line_cb

  // ---------- backup_line
  function do_ajax_form_cliente_sophos_editar_backup_line(iNumLinha)
  {
    var var_id_cliente_ = scAjaxGetFieldText("id_cliente_" + iNumLinha);
    var var_nombre_ = scAjaxGetFieldText("nombre_" + iNumLinha);
    var var_nmgp_refresh_row = iNumLinha;
    var var_nm_form_submit = document.F1.nm_form_submit.value;
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_cliente_sophos_editar_backup_line(var_id_cliente_, var_nombre_, var_nmgp_refresh_row, var_nm_form_submit, var_script_case_init, do_ajax_form_cliente_sophos_editar_backup_line_cb);
  } // do_ajax_form_cliente_sophos_editar_backup_line

  function do_ajax_form_cliente_sophos_editar_backup_line_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    if (!scAjaxHasError())
  ...
  } // do_ajax_form_cliente_sophos_editar_backup_line_cb

  function do_ajax_form_cliente_sophos_editar_cancel_insert(iSeqVert)
  {
    var oTBodyOld = document.getElementById("hidden_bloco_0").tBodies[0];
  ...
  } // do_ajax_form_cliente_sophos_editar_cancel_insert

  function do_ajax_form_cliente_sophos_editar_cancel_update(iSeqVert)
  {
    do_ajax_form_cliente_sophos_editar_backup_line(iSeqVert);
...
?>
  } // do_ajax_form_cliente_sophos_editar_cancel_update

  function do_ajax_form_cliente_sophos_editar_restore_buttons()
  {
<?php
...
?>
  } // do_ajax_form_cliente_sophos_editar_restore_buttons

  // ---------- table_refresh
  function do_ajax_form_cliente_sophos_editar_table_refresh()
  {
    var var_id_cliente_ = document.F2.id_cliente_.value;
    var var_nombre_ = document.F2.nombre_.value;
    ...
    scAjaxProcOn();
    x_ajax_form_cliente_sophos_editar_table_refresh(var_id_cliente_, var_nombre_, var_nm_form_submit, var_nmgp_opcao, var_nmgp_ordem, var_nmgp_fast_search, var_nmgp_cond_fast_search, var_nmgp_arg_fast_search, var_nmgp_arg_dyn_search, var_script_case_init, do_ajax_form_cliente_sophos_editar_table_refresh_cb);
  } //  do_ajax_form_cliente_sophos_editar_table_refresh

  function do_ajax_form_cliente_sophos_editar_table_refresh_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    document.F2.id_cliente_.value = scAjaxGetKeyValue("id_cliente_");
    document.F2.nombre_.value = scAjaxGetKeyValue("nombre_");
    ...
    scAjaxAlert(do_ajax_form_cliente_sophos_editar_table_refresh_cb_after_alert);
  } // do_ajax_form_cliente_sophos_editar_table_refresh_cb
  function do_ajax_form_cliente_sophos_editar_table_refresh_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    ...
    sc_insert_open = false;
  } // do_ajax_form_cliente_sophos_editar_table_refresh_cb_after_alert
...
function scJs_sweetalert_params(params) {
  ...
  var sc_num_ult_opc  = "";
  var sc_num_ult_tr   = "";
  function do_ajax_form_cliente_sophos_editar_submit_form(iNumLinha, indexTR)
  {
    if (scEventControl_active(iNumLinha)) {
      setTimeout(function() { do_ajax_form_cliente_sophos_editar_submit_form(iNumLinha, indexTR); }, 500);
      return;
    }
    ...
    var var_id_cliente_ = scAjaxGetFieldText("id_cliente_" + iNumLinha);
    var var_nombre_ = scAjaxGetFieldText("nombre_" + iNumLinha);
    var var_fecha_sla_inicio_ = scAjaxGetFieldText("fecha_sla_inicio_" + iNumLinha);
    var var_fecha_sla_fin_ = scAjaxGetFieldText("fecha_sla_fin_" + iNumLinha);
    var var_nm_form_submit = document.F1.nm_form_submit.value;
...
?>
    x_ajax_form_cliente_sophos_editar_submit_form(var_id_cliente_, var_nombre_, var_fecha_sla_inicio_, var_fecha_sla_fin_, var_nmgp_refresh_row, var_nm_form_submit, var_nmgp_url_saida, var_nmgp_opcao, var_nmgp_ancora, var_nmgp_num_form, var_nmgp_parms, var_script_case_init, var_csrf_token, do_ajax_form_cliente_sophos_editar_submit_form_cb);
  } // do_ajax_form_cliente_sophos_editar_submit_form

  function do_ajax_form_cliente_sophos_editar_submit_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
...
?>
      ...
      scAjaxHideErrorDisplay("table");
      scAjaxHideErrorDisplay("id_cliente_" + sc_num_ult_line);
      scAjaxHideErrorDisplay("nombre_" + sc_num_ult_line);
      scAjaxHideErrorDisplay("fecha_sla_inicio_" + sc_num_ult_line);
      scAjaxHideErrorDisplay("fecha_sla_fin_" + sc_num_ult_line);
<?php
if (isset($this->Embutida_form) && $this->Embutida_form) {
?>
      scAjaxSetReadonly();
...
?>
    ...
    scAjaxSetLabel(true);
    scAjaxSetMaster();
    scAjaxAlert(do_ajax_form_cliente_sophos_editar_submit_form_cb_after_alert);
  } // do_ajax_form_cliente_sophos_editar_submit_form_cb
  function do_ajax_form_cliente_sophos_editar_submit_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  ...
  } // do_ajax_form_cliente_sophos_editar_submit_form_cb_after_alert

  var scStatusDetail = {};

  function do_ajax_form_cliente_sophos_editar_navigate_form()
  {
    perform_ajax_form_cliente_sophos_editar_navigate_form();
  }

  function perform_ajax_form_cliente_sophos_editar_navigate_form()
  {
    if (scRefreshTable())
    {
      return;
    ...
    if (sc_insert_open)
    {
        do_ajax_form_cliente_sophos_editar_cancel_insert(sc_form_cliente_sophos_editar_get_last_line_number());
    }
    nm_uncheck_delete();
    scAjaxHideMessage();
    scAjaxHideErrorDisplay("table");
    ...
    {
      scAjaxHideErrorDisplay("id_cliente_" + iNavForm);
      scAjaxHideErrorDisplay("nombre_" + iNavForm);
      scAjaxHideErrorDisplay("fecha_sla_inicio_" + iNavForm);
      scAjaxHideErrorDisplay("fecha_sla_fin_" + iNavForm);
    }
    var var_id_cliente_ = document.F2.id_cliente_.value;
    var var_nombre_ = document.F2.nombre_.value;
    var var_nm_form_submit = document.F2.nm_form_submit.value;
    ...
    var var_script_case_init = document.F2.script_case_init.value;
    scAjaxProcOn();
    x_ajax_form_cliente_sophos_editar_navigate_form(var_id_cliente_, var_nombre_, var_nm_form_submit, var_nmgp_opcao, var_nmgp_ordem, var_nmgp_arg_dyn_search, var_script_case_init, do_ajax_form_cliente_sophos_editar_navigate_form_cb);
  } // do_ajax_form_cliente_sophos_editar_navigate_form

  var scMasterDetailParentIframe = "<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['form_cliente_sophos_editar']['dashboard_info']['parent_widget'] ?>";
...
?>
  function do_ajax_form_cliente_sophos_editar_navigate_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetFields(false);
    scAjaxSetVariables();
    document.F2.id_cliente_.value = scAjaxGetKeyValue("id_cliente_" + var_last_index);
    document.F2.nombre_.value = scAjaxGetKeyValue("nombre_" + var_last_index);
    ...
    scErrorLineReset();
    $('.sc-js-ui-statusimg').css('display', 'none');
    scAjaxAlert(do_ajax_form_cliente_sophos_editar_navigate_form_cb_after_alert);
  } // do_ajax_form_cliente_sophos_editar_navigate_form_cb
  function do_ajax_form_cliente_sophos_editar_navigate_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
<?php
...
?>
  ...
  } // do_ajax_form_cliente_sophos_editar_navigate_form_cb_after_alert

    function sc_form_cliente_sophos_editar_get_last_line_number()
    {
    ...
    } //sc_form_cliente_sophos_editar_get_last_line_number

  function sc_hide_form_cliente_sophos_editar_form()
  {
...
?>
  ...
  {
    ajax_field_list[iTotCampos] = "id_cliente_" + iNumLinha;
    iTotCampos++;
    ajax_field_list[iTotCampos] = "nombre_" + iNumLinha;
    iTotCampos++;
    ajax_field_list[iTotCampos] = "fecha_sla_inicio_" + iNumLinha;
    iTotCampos++;
    ajax_field_list[iTotCampos] = "fecha_sla_fin_" + iNumLinha;
    iTotCampos++;
    ajax_error_list["id_cliente_" + iNumLinha] = {"label": "Id Cliente<?php echo $sLineInfo; ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5};
    ...
    ajax_error_list["fecha_sla_inicio_" + iNumLinha] = {"label": "Fecha Sla Inicio<?php echo $sLineInfo; ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5};
    ajax_error_list["fecha_sla_fin_" + iNumLinha] = {"label": "Fecha Sla Fin<?php echo $sLineInfo; ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5};
    ajax_field_mult["id_cliente_"][iNumLinha] = "id_cliente_" + iNumLinha;
    ajax_field_mult["nombre_"][iNumLinha] = "nombre_" + iNumLinha;
    ajax_field_mult["fecha_sla_inicio_"][iNumLinha] = "fecha_sla_inicio_" + iNumLinha;
    ajax_field_mult["fecha_sla_fin_"][iNumLinha] = "fecha_sla_fin_" + iNumLinha;
    ajax_field_id["id_cliente_" + iNumLinha] = new Array("hidden_field_label_id_cliente_", "hidden_field_data_id_cliente_" + iNumLinha);
    ajax_field_id["nombre_" + iNumLinha] = new Array("hidden_field_label_nombre_", "hidden_field_data_nombre_" + iNumLinha);
    ajax_field_id["fecha_sla_inicio_" + iNumLinha] = new Array("hidden_field_label_fecha_sla_inicio_", "hidden_field_data_fecha_sla_inicio_" + iNumLinha);
    ajax_field_id["fecha_sla_fin_" + iNumLinha] = new Array("hidden_field_label_fecha_sla_fin_", "hidden_field_data_fecha_sla_fin_" + iNumLinha);
    ajax_error_count["id_cliente_" + iNumLinha] = "off";
    ajax_error_count["nombre_" + iNumLinha] = "off";
    ajax_error_count["fecha_sla_inicio_" + iNumLinha] = "off";
    ajax_error_count["fecha_sla_fin_" + iNumLinha] = "off";
<?php
if (!$this->Grid_editavel)
{
?>
    ajax_read_only["id_cliente_" + iNumLinha] = "on";
    ajax_read_only["nombre_" + iNumLinha] = "on";
    ajax_read_only["fecha_sla_inicio_" + iNumLinha] = "off";
    ajax_read_only["fecha_sla_fin_" + iNumLinha] = "off";
<?php
}
else
{
?>
    ajax_read_only["id_cliente_" + iNumLinha] = "on";
    ajax_read_only["nombre_" + iNumLinha] = "on";
    ajax_read_only["fecha_sla_inicio_" + iNumLinha] = "on";
    ajax_read_only["fecha_sla_fin_" + iNumLinha] = "on";
<?php
}
?>
  }
  ...
  {
    ajax_error_list["id_cliente_" + iNumLinha] = null;
    ajax_error_list["nombre_" + iNumLinha] = null;
    ajax_error_list["fecha_sla_inicio_" + iNumLinha] = null;
    ajax_error_list["fecha_sla_fin_" + iNumLinha] = null;
  }
  ...
  var ajax_field_mult = {
    "id_cliente_": new Array(),
    "nombre_": new Array(),
    "fecha_sla_inicio_": new Array(),
    "fecha_sla_fin_": new Array()
  };
  ...
  function scRemoveErrors()
  {
    for (iNumLinha = 1; iNumLinha < Lim_linhas; iNumLinha++)
    {
      ajax_error_list["id_cliente_" + iNumLinha]["valid"] = new Array();
      ajax_error_list["id_cliente_" + iNumLinha]["onblur"] = new Array();
      ajax_error_list["id_cliente_" + iNumLinha]["onchange"] = new Array();
      ajax_error_list["id_cliente_" + iNumLinha]["onclick"] = new Array();
      ajax_error_list["id_cliente_" + iNumLinha]["onfocus"] = new Array();
      ...
      ajax_error_list["fecha_sla_inicio_" + iNumLinha]["valid"] = new Array();
      ajax_error_list["fecha_sla_inicio_" + iNumLinha]["onblur"] = new Array();
      ajax_error_list["fecha_sla_inicio_" + iNumLinha]["onchange"] = new Array();
      ajax_error_list["fecha_sla_inicio_" + iNumLinha]["onclick"] = new Array();
      ajax_error_list["fecha_sla_inicio_" + iNumLinha]["onfocus"] = new Array();
      ajax_error_list["fecha_sla_fin_" + iNumLinha]["valid"] = new Array();
      ajax_error_list["fecha_sla_fin_" + iNumLinha]["onblur"] = new Array();
      ajax_error_list["fecha_sla_fin_" + iNumLinha]["onchange"] = new Array();
      ajax_error_list["fecha_sla_fin_" + iNumLinha]["onclick"] = new Array();
      ajax_error_list["fecha_sla_fin_" + iNumLinha]["onfocus"] = new Array();
    }
  }
...
?>
  ...
  {
<?php
  $NM_contr_readonly = (isset($this->nmgp_cmp_readonly['id_cliente_'])) ? $this->nmgp_cmp_readonly['id_cliente_'] : 'on';
?>
    scAjaxFieldRead("id_cliente_" + iSeq, "<?php echo $NM_contr_readonly ?>");
<?php
  $NM_contr_readonly = (isset($this->nmgp_cmp_readonly['nombre_'])) ? $this->nmgp_cmp_readonly['nombre_'] : 'on';
?>
    scAjaxFieldRead("nombre_" + iSeq, "<?php echo $NM_contr_readonly ?>");
<?php
  $NM_contr_readonly = (isset($this->nmgp_cmp_readonly['fecha_sla_inicio_'])) ? $this->nmgp_cmp_readonly['fecha_sla_inicio_'] : 'off';
?>
    scAjaxFieldRead("fecha_sla_inicio_" + iSeq, "<?php echo $NM_contr_readonly ?>");
<?php
  $NM_contr_readonly = (isset($this->nmgp_cmp_readonly['fecha_sla_fin_'])) ? $this->nmgp_cmp_readonly['fecha_sla_fin_'] : 'off';
?>
    scAjaxFieldRead("fecha_sla_fin_" + iSeq, "<?php echo $NM_contr_readonly ?>");
  }

  function mdCloseObjects(iSeq)
  {
    scAjaxFieldRead("id_cliente_" + iSeq, "on");
    scAjaxFieldRead("nombre_" + iSeq, "on");
    scAjaxFieldRead("fecha_sla_inicio_" + iSeq, "on");
    scAjaxFieldRead("fecha_sla_fin_" + iSeq, "on");
    rerunHeaderDisplay = 1;
    scSetFixedHeaders(true);
  }
...
?>
  ...
  function scErrorLineOn(iRow, sIdError)
  {
    ...
    if (bErrorRow || ("on" == ajax_error_count["id_cliente_" + iRow] || "on" == ajax_error_count["nombre_" + iRow] || "on" == ajax_error_count["fecha_sla_inicio_" + iRow] || "on" == ajax_error_count["fecha_sla_fin_" + iRow]))
    {
      $("#hidden_field_data_sc_seq" + iRow).addClass("scFormErrorLine");
      $("#hidden_field_data_sc_actions" + iRow).addClass("scFormErrorLine");
      $("#hidden_field_data_id_cliente_" + iRow).addClass("scFormErrorLine");
      $("#hidden_field_data_nombre_" + iRow).addClass("scFormErrorLine");
      $("#hidden_field_data_fecha_sla_inicio_" + iRow).addClass("scFormErrorLine");
      $("#hidden_field_data_fecha_sla_fin_" + iRow).addClass("scFormErrorLine");
    }
  }
  ...
  function scErrorLineOff(iRow, sIdError)
  {
    ...
    if (bErrorRow || ("off" == ajax_error_count["id_cliente_" + iRow] && "off" == ajax_error_count["nombre_" + iRow] && "off" == ajax_error_count["fecha_sla_inicio_" + iRow] && "off" == ajax_error_count["fecha_sla_fin_" + iRow]))
    {
      if (bErrorRow)
      {
        ajax_error_count["id_cliente_" + iRow] = "off";
        ajax_error_count["nombre_" + iRow] = "off";
        ajax_error_count["fecha_sla_inicio_" + iRow] = "off";
        ajax_error_count["fecha_sla_fin_" + iRow] = "off";
      }
      ...
      $("#hidden_field_data_id_cliente_" + iRow).removeClass("scFormErrorLine");
      $("#hidden_field_data_nombre_" + iRow).removeClass("scFormErrorLine");
      $("#hidden_field_data_fecha_sla_inicio_" + iRow).removeClass("scFormErrorLine");
      $("#hidden_field_data_fecha_sla_fin_" + iRow).removeClass("scFormErrorLine");
    }
  }
