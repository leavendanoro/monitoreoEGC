  ...
  function scAjaxUpdateErrors(sType)
  {
    ...
    if (oResp["errList"])
    {
      for (iFieldErrors = 0; iFieldErrors < oResp["errList"].length; iFieldErrors++)
      {
        ...
        if ("geral_form_agentes" == sTestField)
        {
...
?>
  ...
  // ---------- Validate agente_
  function do_ajax_form_agentes_validate_agente_(iNumLinha)
  {
    var nomeCampo_agente_ = "agente_" + iNumLinha;
    var var_agente_ = scAjaxGetFieldText(nomeCampo_agente_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_agentes_validate_agente_(var_agente_, iNumLinha, var_script_case_init, do_ajax_form_agentes_validate_agente__cb);
  } // do_ajax_form_agentes_validate_agente_

  function do_ajax_form_agentes_validate_agente__cb(sResp)
  {
    ...
    if ("" != iLineNumber)
    {
      sFieldValid = "agente_" + iLineNumber;
    }
    else
    {
      sFieldValid = "agente_";
    ...
    if ("" == sFieldErrors)
    {
      ...
      scErrorLineOff(iLineNumber, "agente_");
    }
    else
    {
      var sImgStatus = sc_img_status_err;
      scAjaxShowErrorDisplay(sFieldValid, sFieldErrors);
      scErrorLineOn(iLineNumber, "agente_");
    }
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_agentes_validate_agente__cb

  // ---------- Validate email_
  function do_ajax_form_agentes_validate_email_(iNumLinha)
  {
    var nomeCampo_email_ = "email_" + iNumLinha;
    var var_email_ = scAjaxGetFieldText(nomeCampo_email_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_agentes_validate_email_(var_email_, iNumLinha, var_script_case_init, do_ajax_form_agentes_validate_email__cb);
  } // do_ajax_form_agentes_validate_email_

  function do_ajax_form_agentes_validate_email__cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    iLineNumber = scAjaxGetLineNumber();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_agentes_validate_email__cb

  var sc_num_ult_line = "";
  var sc_insert_open  = false;

  // ---------- add_new_line
  function do_ajax_form_agentes_add_new_line(sc_clone, sc_seq_clone)
  {
    if (sc_insert_open)
    {
        if (sc_clone == 'S' && sc_seq_clone != iAjaxNewLine)
        {
          do_ajax_form_agentes_cancel_insert(iAjaxNewLine);
        }
        else
        {
          return;
    ...
    var var_script_case_init = document.F1.script_case_init.value;
    scAjaxProcOn(true);
    x_ajax_form_agentes_add_new_line(var_sc_clone, var_sc_seq_clone, var_sc_seq_vert, var_script_case_init, do_ajax_form_agentes_add_new_line_cb);
  } // do_ajax_form_agentes_add_new_line

  function do_ajax_form_agentes_add_new_line_cb(sResp)
  {
    scAjaxProcOff(true);
    if ("{" == sResp.substr(0, 1)) {
        oResp = scAjaxResponse(sResp);
  ...
  } // do_ajax_form_agentes_add_new_line_cb

  // ---------- backup_line
  function do_ajax_form_agentes_backup_line(iNumLinha)
  {
    var var_agente_ = scAjaxGetFieldText("agente_" + iNumLinha);
    var var_nmgp_refresh_row = iNumLinha;
    var var_nm_form_submit = document.F1.nm_form_submit.value;
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_agentes_backup_line(var_agente_, var_nmgp_refresh_row, var_nm_form_submit, var_script_case_init, do_ajax_form_agentes_backup_line_cb);
  } // do_ajax_form_agentes_backup_line

  function do_ajax_form_agentes_backup_line_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    if (!scAjaxHasError())
  ...
  } // do_ajax_form_agentes_backup_line_cb

  function do_ajax_form_agentes_cancel_insert(iSeqVert)
  {
    var oTBodyOld = document.getElementById("hidden_bloco_0").tBodies[0];
  ...
  } // do_ajax_form_agentes_cancel_insert

  function do_ajax_form_agentes_cancel_update(iSeqVert)
  {
    do_ajax_form_agentes_backup_line(iSeqVert);
...
?>
  } // do_ajax_form_agentes_cancel_update

  function do_ajax_form_agentes_restore_buttons()
  {
<?php
...
?>
  } // do_ajax_form_agentes_restore_buttons

  // ---------- table_refresh
  function do_ajax_form_agentes_table_refresh()
  {
    var var_agente_ = document.F2.agente_.value;
    ...
    scAjaxProcOn();
    x_ajax_form_agentes_table_refresh(var_agente_, var_nm_form_submit, var_nmgp_opcao, var_nmgp_ordem, var_nmgp_fast_search, var_nmgp_cond_fast_search, var_nmgp_arg_fast_search, var_nmgp_arg_dyn_search, var_script_case_init, do_ajax_form_agentes_table_refresh_cb);
  } //  do_ajax_form_agentes_table_refresh

  function do_ajax_form_agentes_table_refresh_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    document.F2.agente_.value = scAjaxGetKeyValue("agente_");
    ...
    scAjaxAlert(do_ajax_form_agentes_table_refresh_cb_after_alert);
  } // do_ajax_form_agentes_table_refresh_cb
  function do_ajax_form_agentes_table_refresh_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    ...
    sc_insert_open = false;
  } // do_ajax_form_agentes_table_refresh_cb_after_alert
...
function scJs_sweetalert_params(params) {
  ...
  var sc_num_ult_opc  = "";
  var sc_num_ult_tr   = "";
  function do_ajax_form_agentes_submit_form(iNumLinha, indexTR)
  {
    if (scEventControl_active(iNumLinha)) {
      setTimeout(function() { do_ajax_form_agentes_submit_form(iNumLinha, indexTR); }, 500);
      return;
    }
...
?>
    x_ajax_form_agentes_submit_form(var_agente_, var_email_, var_nmgp_refresh_row, var_nm_form_submit, var_nmgp_url_saida, var_nmgp_opcao, var_nmgp_ancora, var_nmgp_num_form, var_nmgp_parms, var_script_case_init, var_csrf_token, do_ajax_form_agentes_submit_form_cb);
  } // do_ajax_form_agentes_submit_form

  function do_ajax_form_agentes_submit_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
...
?>
      ...
      scAjaxHideErrorDisplay("table");
      scAjaxHideErrorDisplay("agente_" + sc_num_ult_line);
...
?>
    ...
    scAjaxSetLabel(true);
    scAjaxSetMaster();
    scAjaxAlert(do_ajax_form_agentes_submit_form_cb_after_alert);
  } // do_ajax_form_agentes_submit_form_cb
  function do_ajax_form_agentes_submit_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  ...
  } // do_ajax_form_agentes_submit_form_cb_after_alert

  var scStatusDetail = {};

  function do_ajax_form_agentes_navigate_form()
  {
    perform_ajax_form_agentes_navigate_form();
  }

  function perform_ajax_form_agentes_navigate_form()
  {
    if (scRefreshTable())
    {
      return;
    ...
    if (sc_insert_open)
    {
        do_ajax_form_agentes_cancel_insert(sc_form_agentes_get_last_line_number());
    }
    nm_uncheck_delete();
    scAjaxHideMessage();
    scAjaxHideErrorDisplay("table");
    ...
    {
      scAjaxHideErrorDisplay("agente_" + iNavForm);
    ...
    var var_script_case_init = document.F2.script_case_init.value;
    scAjaxProcOn();
    x_ajax_form_agentes_navigate_form(var_agente_, var_nm_form_submit, var_nmgp_opcao, var_nmgp_ordem, var_nmgp_arg_dyn_search, var_script_case_init, do_ajax_form_agentes_navigate_form_cb);
  } // do_ajax_form_agentes_navigate_form

  var scMasterDetailParentIframe = "<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['form_agentes']['dashboard_info']['parent_widget'] ?>";
...
?>
  function do_ajax_form_agentes_navigate_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetFields(false);
    scAjaxSetVariables();
    document.F2.agente_.value = scAjaxGetKeyValue("agente_" + var_last_index);
    ...
    scErrorLineReset();
    $('.sc-js-ui-statusimg').css('display', 'none');
    scAjaxAlert(do_ajax_form_agentes_navigate_form_cb_after_alert);
  } // do_ajax_form_agentes_navigate_form_cb
  function do_ajax_form_agentes_navigate_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
<?php
...
?>
  ...
  } // do_ajax_form_agentes_navigate_form_cb_after_alert

    function sc_form_agentes_get_last_line_number()
    {
    ...
    } //sc_form_agentes_get_last_line_number

  function sc_hide_form_agentes_form()
  {
...
?>
  ...
  {
    ajax_field_list[iTotCampos] = "agente_" + iNumLinha;
    iTotCampos++;
    ajax_field_list[iTotCampos] = "email_" + iNumLinha;
    iTotCampos++;
    ajax_error_list["agente_" + iNumLinha] = {"label": "Agente<?php echo $sLineInfo; ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5};
    ...
    ajax_field_mult["agente_"][iNumLinha] = "agente_" + iNumLinha;
    ajax_field_mult["email_"][iNumLinha] = "email_" + iNumLinha;
    ajax_field_id["agente_" + iNumLinha] = new Array("hidden_field_label_agente_", "hidden_field_data_agente_" + iNumLinha);
    ajax_field_id["email_" + iNumLinha] = new Array("hidden_field_label_email_", "hidden_field_data_email_" + iNumLinha);
    ajax_error_count["agente_" + iNumLinha] = "off";
    ajax_error_count["email_" + iNumLinha] = "off";
<?php
if (!$this->Grid_editavel)
{
?>
    ajax_read_only["agente_" + iNumLinha] = "on";
...
?>
  ...
  {
    ajax_error_list["agente_" + iNumLinha] = null;
  ...
  function scRemoveErrors()
  {
    for (iNumLinha = 1; iNumLinha < Lim_linhas; iNumLinha++)
    {
      ajax_error_list["agente_" + iNumLinha]["valid"] = new Array();
      ajax_error_list["agente_" + iNumLinha]["onblur"] = new Array();
      ajax_error_list["agente_" + iNumLinha]["onchange"] = new Array();
      ajax_error_list["agente_" + iNumLinha]["onclick"] = new Array();
      ajax_error_list["agente_" + iNumLinha]["onfocus"] = new Array();
...
?>
  ...
  {
<?php
  $NM_contr_readonly = (isset($this->nmgp_cmp_readonly['agente_'])) ? $this->nmgp_cmp_readonly['agente_'] : 'on';
?>
    scAjaxFieldRead("agente_" + iSeq, "<?php echo $NM_contr_readonly ?>");
<?php
...
?>
  ...
  {
    scAjaxFieldRead("agente_" + iSeq, "on");
...
?>
  ...
  function scErrorLineOn(iRow, sIdError)
  {
    ...
    if (bErrorRow || ("on" == ajax_error_count["agente_" + iRow] || "on" == ajax_error_count["email_" + iRow]))
    {
      $("#hidden_field_data_sc_seq" + iRow).addClass("scFormErrorLine");
      $("#hidden_field_data_sc_actions" + iRow).addClass("scFormErrorLine");
      $("#hidden_field_data_agente_" + iRow).addClass("scFormErrorLine");
  ...
  function scErrorLineOff(iRow, sIdError)
  {
    ...
    if (bErrorRow || ("off" == ajax_error_count["agente_" + iRow] && "off" == ajax_error_count["email_" + iRow]))
    {
      if (bErrorRow)
      {
        ajax_error_count["agente_" + iRow] = "off";
      ...
      $("#hidden_field_data_agente_" + iRow).removeClass("scFormErrorLine");
